    ...
    <AppCard>
      <template #header>
        ...
        <div class="flex q-gutter-x-sm items-center q-mt-sm text-grey-8">
          ...
          <q-space />
          <a
            class="text-bold" href="https://www.inflearn.com/course/vue-%EC%99%84%EB%B2%BD-%EA%B8%B0%EB%B3%B8#reviews"
            target="_blank"
          >
            수강평 보기
          </a>
      ...
      <div class="row q-col-gutter-md">
        <div class="col-6">
          <q-btn
            label="인프런에서 수강하기" unelevated class="full-width" color="primary" href="https://inf.run/yWHo"
            target="_blank" />
        </div>
        <div class="col-6">
          <q-btn
            label="짐코딩 클럽에서 수강하기" unelevated class="full-width" color="red"
